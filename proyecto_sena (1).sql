...
-- Tiempo de generación: 03-11-2023 a las 20:18:49
...
(2, 'Temperatura', 'ESP32', 1, 'Temperatura de peces', 1),
(3, 'LED', 'ESP32', 2, 'Led de invernaderos', 1),
(4, 'Turbiedad', 'ESP32', 1, 'Turbiedad del agua ', 1);
...
ALTER TABLE `dispositivos`
  ...
  ADD KEY `dispositivos_ibfk_2` (`id_usuario`);
...
--
ALTER TABLE `dispositivos`
  ADD CONSTRAINT `dispositivos_ibfk_1` FOREIGN KEY (`id_unidad`) REFERENCES `unidades` (`id`),
  ADD CONSTRAINT `dispositivos_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
